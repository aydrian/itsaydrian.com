  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12">
          <h2 className="text-foreground mb-6 text-2xl font-bold">Apps</h2>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            <Link className="group" to="/apps/tiny-maintenance">
              <Card className="h-full cursor-pointer transition-all hover:scale-[1.02] hover:shadow-lg">
                <CardHeader className="text-center">
                  <img
                  ...
                  />
                  <CardTitle className="text-xl">Tiny Maintenance</CardTitle>
                  <CardDescription>
                    Track recurring maintenance tasks for your home, car, garden,
                    and more.
                  </CardDescription>
                </CardHeader>
              </Card>
