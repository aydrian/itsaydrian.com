      ...
      <div className="flex w-full max-w-sm flex-col items-center gap-4 md:max-w-5xl md:flex-row md:justify-evenly md:gap-8">
        <header className="md:basis-1/2">
          <figure className="min-h-fit w-3/4 min-w-fit sm:w-48 md:w-3/4">
            <div className="mx-auto aspect-square w-full rounded-full bg-linear-to-r from-cyan-500 to-green-500 p-1 shadow-xs">
              <img
                alt="Atticus and Me"
          ...
          <div className="text-center">
            <h1 className="mx-auto max-w-fit bg-linear-to-r from-cyan-500 to-green-500 bg-clip-text text-4xl font-bold text-transparent md:text-6xl">
              Aydrian Howard
            </h1>
