  ...
  return (
    <div className="flex min-h-screen w-screen flex-col items-center gap-4 bg-linear-to-r from-cyan-500 to-green-500 text-white md:flex-row-reverse md:justify-center md:gap-0">
      <img
        ...
        src={atticusAndMe}
      />
      <div className="bg-opacity-75 flex h-full max-w-xl flex-col items-center justify-center rounded-lg bg-blue-950 px-12 py-6 shadow-sm md:mx-auto md:grow">
        <div className="flex h-full grow flex-col justify-center gap-1.5">
          <h1 className="max-w-fit bg-linear-to-r from-cyan-500 to-green-500 bg-clip-text text-center text-4xl leading-tight font-bold text-transparent md:text-6xl">
            It&apos;s Aydrian
          </h1>
          <h2 className="text-center text-2xl leading-tight font-semibold md:text-4xl">
            Hoosier in the Big City
          </h2>
          <h3 className="max-w-fit bg-linear-to-r from-cyan-500 to-green-500 bg-clip-text leading-tight font-bold text-transparent md:text-xl">
